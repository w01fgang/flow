...
type child_process$execOpts = {
  cwd?: string,
  env?: Object,
  encoding?: buffer$NonBufferEncoding | 'buffer',
  shell?: string,
  timeout?: number,
  maxBuffer?: number,
...
type child_process$execCallback<T: string | Buffer> = (error: ?child_process$Error, stdout: T, stderr: T) => void;
...
type child_process$execFileCallback<T: string | Buffer> = (error: ?child_process$Error, stdout: T, stderr: T) => void;
...
declare module "child_process" {
  ...
  declare function exec(
    command: string,
    optionsOrCallback?: { ...child_process$execOpts, +encoding?: buffer$NonBufferEncoding, ... } | child_process$execCallback<string>,
  ): child_process$ChildProcess;

  declare function exec(
    command: string,
    options?: { ...child_process$execOpts, +encoding?: buffer$NonBufferEncoding, ... },
    callback?: child_process$execCallback<string>
  ): child_process$ChildProcess;

  declare function exec(
    command: string,
    options: { ...child_process$execOpts, +encoding: 'buffer', ... },
    callback?: child_process$execCallback<Buffer>
  ): child_process$ChildProcess;
  ...
  declare function execFile(
    ...
    argsOrOptionsOrCallback?:
      Array<string> | { ...child_process$execFileOpts, +encoding?: buffer$NonBufferEncoding, ... } | child_process$execFileCallback<string>,
    optionsOrCallback?: { ...child_process$execFileOpts, +encoding?: buffer$NonBufferEncoding, ... } | child_process$execFileCallback<string>,
  ...
  declare function execFile(
    file: string,
    args: Array<string>,
    options: { ...child_process$execFileOpts, +encoding: 'buffer', ... },
    callback?: child_process$execFileCallback<Buffer>
  ): child_process$ChildProcess;
